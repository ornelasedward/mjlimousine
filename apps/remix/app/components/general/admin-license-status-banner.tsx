        ...
        <div className="flex items-center">
          ...
          {match(licenseStatus)
            ...
            .with('UNAUTHORIZED', () =>
              license ? (
                <Trans>
                  Invalid License Type - Your MJ Limousine instance is using features that are not part
                  of your license.
                </Trans>
              ) : (
                <Trans>
                  Missing License - Your MJ Limousine instance is using features that require a
                  license.
                </Trans>
              ),
            )
