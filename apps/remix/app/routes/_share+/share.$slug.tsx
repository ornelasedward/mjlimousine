...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'MJ Limousine - Share' },
    { description: 'I just signed a document in style with MJ Limousine!' },
    {
      property: 'og:title',
      content: 'MJ Limousine - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with MJ Limousine!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for MJ Limousine.
